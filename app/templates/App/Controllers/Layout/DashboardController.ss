        ...
        <% if $AnyCardsActive %>
            ...
            <% if $EventDaysWithoutFeedback %>
                <div class="section_infobox">
                    ...
                    <ul class="infobox_list">
                        <% loop $EventDaysWithoutFeedback.Limit(10) %>
                            <li class="käse"><a href="$Link">$RenderTitle - <i>$RenderDateWithTime</i></a></li>
                        <% end_loop %>
                    </ul>
                </div>
            <% end_if %>
            ...
            <% end_if %>
        <% else %>
            <div class="nothinggoingon">
                <p class="nothing_text">Aktuell herrscht hier tote Hose...</b></p>
                <a href="/calendar" class="button">Zum Kalender</a>
            </div>
        <% end_if %>
    </div>
</div>
