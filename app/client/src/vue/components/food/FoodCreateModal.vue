<template>
  <AppModal ref="modal" class="food-create-modal" title="Gericht hinzufügen" @close="close">
    <form id="food-create-form" class="modalform" @submit.prevent="submit">
      <label class="field">
        Bezeichnung *
        <input
          id="food-create-title"
          v-model="form.title"
          type="text"
      ...
      <label v-if="form.isOrderable" class="field">
        ...
        <input
          ...
          placeholder="0"
        >
        <small class="food-create-modal_hint">0 = unbegrenzt</small>
      </label>
    ...
    <template #actions>
      ...
      <AppButton type="submit" form="food-create-form" variant="primary" :disabled="saving || !form.title.trim()">
